...
__C.BACKBONE.TYPE = 'siamrpn_pp.models.backbone.resnet_atrous.resnet50'
...
# Adjust layer type
__C.ADJUST.TYPE = "siamrpn_pp.models.neck.neck.AdjustAllLayer"
...
# RPN type
__C.RPN.TYPE = 'siamrpn_pp.models.head.rpn.MultiRPN'
...
# Mask type
__C.MASK.MASK_TYPE = "siamrpn_pp.models.head.mask.MaskCorr"
...
# Refine type
__C.MASK.REFINE_TYPE = "siamrpn_pp.models.head.mask.Refine"
...
__C.TRACK.TYPE = 'siamrpn_pp.tracker.siamrpn_tracker.SiamRPNTracker'
